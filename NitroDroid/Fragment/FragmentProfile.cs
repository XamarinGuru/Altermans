...
namespace goheja
{
    public class FragmentProfile : Android.Support.V4.App.Fragment
    {
		...
		#region remove existing Lamdan calendar
			...
			try
			{
				...
				if (cursor.MoveToFirst())
				{
					do
					{
						...
						if (displayName == "500WATT Calendar")
							RemoveCalendar(id);
		...
		private void RemoveCalendar(long calID)
		{
			try{
				...
				String[] selArgs = new String[] { "500WATT Calendar" };
        ...
        void ExportBitmapAsPNG(Bitmap bitmap)
        {
            try
            {
                ...
                var filePath = System.IO.Path.Combine(sdCardPath, "data/goheja.fivewa.com/files/me.png");
